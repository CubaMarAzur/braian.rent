...
function getStatusIcon(status: string) {
  ...
  return (
    <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-red-100 text-red-600">
      {/* Warning SVG */}
      <svg className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 16 16">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8 4v4m0 3.5h.01" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow p-6 flex flex-col">
          ...
          <div className="flex items-center">
            ...
            <div>
              <div className="text-gray-800 font-medium text-base">Anna Nowak</div>
              <div className="flex space-x-2 mt-2">
                {/* Phone */}
                <button className="w-8 h-8 rounded-full bg-gray-100 hover:bg-blue-100 flex items-center justify-center text-blue-600 transition" aria-label="Zadzwoń">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 20 20">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.5 5.5A16 16 0 0014.5 17.5l2-2a2 2 0 00-2.3-3.3l-1.2.5a1 1 0 01-1.1-.2l-2.2-2.2a1 1 0 01-.2-1.1l.5-1.2A2 2 0 007.5 3.5l-2 2z" />
                  </svg>
                </button>
                {/* Email */}
                <button className="w-8 h-8 rounded-full bg-gray-100 hover:bg-blue-100 flex items-center justify-center text-blue-600 transition" aria-label="Wyślij email">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 20 20">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 7l7 5 7-5M5 5h10a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2z" />
                  </svg>
                </button>
                {/* Chat */}
                <button className="w-8 h-8 rounded-full bg-gray-100 hover:bg-blue-100 flex items-center justify-center text-blue-600 transition" aria-label="Czat">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 20 20">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M17 8c0 3.866-3.582 7-8 7a8.96 8.96 0 01-4-.93L2 17l2.93-2A8.96 8.96 0 011 8c0-3.866 3.582-7 8-7s8 3.134 8 7z" />
                  </svg>
                </button>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow p-6 flex flex-col">
          <h2 className="text-gray-700 font-semibold text-lg mb-4">Bieżące Płatności</h2>
          <div className="flex items-center justify-between mb-2">
            <div>
              <div className="text-gray-500 text-sm">Termin płatności</div>
              <div className="text-gray-800 font-medium text-base">10.10.2025</div>
            </div>
          ...
          <div className="mt-4">
            <span className="inline-flex items-center px-3 py-1 rounded-full bg-red-100 text-red-700 text-sm font-medium">
              ...
              <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 20 20">
                <path strokeLinecap="round" strokeLinejoin="round" d="M10.29 3.86l7.39 13.48A1 1 0 0116.61 19H3.39a1 1 0 01-.87-1.66l7.39-13.48a1 1 0 011.74 0z" />
